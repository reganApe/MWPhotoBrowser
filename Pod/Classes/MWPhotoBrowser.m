...
- (void)actionButtonPressed:(id)sender {
    ...
    if ([self numberOfPhotos] > 0 && [photo underlyingImage]) {
        ...
        if ([self.delegate respondsToSelector:@selector(photoBrowser:didTapActionButton:forPhotoAtIndex:)]) {
            
            // Let delegate handle things
            [self.delegate photoBrowser:self didTapActionButton:sender forPhotoAtIndex:_currentPageIndex];
